...
#include "newton_raphson_enhanced_px4_cpp/px4_utils/flight_phases.hpp"
#include "newton_raphson_enhanced_px4_cpp/transformations/adjust_yaw.hpp"
...
private:
    ...
    Eigen::Vector4d ref_rate_ = Eigen::Vector4d::Zero();
