...
static void print_usage() {
    std::cerr <<
        "\nUsage: ros2 run newton_raphson_enhanced_px4_cpp run_node [OPTIONS]\n"
        "\n"
        "Newton-Raphson Enhanced Offboard Control for Quadrotor\n"
        "\n"
        "Required:\n"
        ...
        "  # -> logs to: src/data_analysis/log_files/newton_raphson_enhanced_px4_cpp/sim_nr_std_helix_2x_spin.csv\n"
        "\n"
        "  # Custom log filename:\n"
        "  ros2 run newton_raphson_enhanced_px4_cpp run_node --platform sim --trajectory helix --log --log-file my_log\n"
        "  # -> logs to: src/data_analysis/log_files/newton_raphson_enhanced_px4_cpp/my_log.csv\n"
        "\n"
        "  # Feedforward:\n"
        "  ros2 run newton_raphson_enhanced_px4_cpp run_node --platform sim --trajectory fig8_horz --ff --log\n"
        "  # -> logs to: src/data_analysis/log_files/newton_raphson_enhanced_px4_cpp/sim_nr_enhanced_fig8_horz_ff_1x.csv\n"
        "\n";
}
...
int main(int argc, char* argv[]) {
    ...
    std::string sep(60, '=');
    std::cout << "\n" << sep << std::endl;
    std::cout << "Newton-Raphson Enhanced Offboard Control Configuration (C++)" << std::endl;
    std::cout << sep << std::endl;
    std::cout << "Platform:      " << qp::platform_type_to_string(args.platform) << std::endl;
    std::cout << "Controller:    ENHANCED" << std::endl;
    ...
    std::cout << "Feedforward:   " << (args.feedforward ? "Enabled" : "Disabled") << std::endl;
    ...
    auto node = std::make_shared<newton_raphson_enhanced_px4_cpp::OffboardControlNode>(
