...
namespace newton_raphson_px4_cpp::px4_utils {

// Forward declaration: the node must have these publishers as public members
// vehicle_command_publisher, offboard_control_mode_publisher
